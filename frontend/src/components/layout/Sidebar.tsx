    ...
    >
      ...
      <div className="mt-8 pt-4">
        <div className="relative rounded-2xl bg-gradient-to-b from-[#f9f1e4] to-[#f4e8d3] p-4 text-center border border-[#eae0d0] overflow-hidden shadow-sm">
          ...
          <div className="absolute inset-0 opacity-15 mix-blend-multiply bg-center bg-cover pointer-events-none" style={{ backgroundImage: `url('/assets/temple_illustration.png')` }} />
